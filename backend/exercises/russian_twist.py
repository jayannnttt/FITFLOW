"""
Russian Twist exercise tracker.
"""
...
class RussianTwist(BaseExercise):
    """
    Tracks Russian Twist repetitions (rep-based).
    """
    ...
    def update(
        ...
        if ang is None:
            alt_joints = self.alt_keypoint_mapping
            if alt_joints:
                ang = angle_engine.get_joint_angle(keypoints, alt_joints, frame_shape)
